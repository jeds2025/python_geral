...
def jogar() -> None:
    ...
    estatisticas_dct = {"pedra": 0, "papel": 0, "tesoura": 0}

    while True:
        print("\n--- Jogo Pedra, Papel, Tesoura ---")
        jogada_jogador = ler_jogada()
        if jogada_jogador in estatisticas_dct:
            estatisticas_dct[jogada_jogador] += 1
    ...
    for jogada, qtd in estatisticas_dct.items():
        print(f"{jogada.capitalize()}: {qtd} vezes")
