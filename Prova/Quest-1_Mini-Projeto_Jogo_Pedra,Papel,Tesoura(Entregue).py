...
CFG = {
    ...
    # Configuração para Coreano 'Pedi ajuda aos universitários... kkkkkkk'
    'ko': {
...
def exibir_resultado_rodada(jogada_jogador: str, jogada_computador: str, vencedor: str) -> None:
    ...
    print(CFG[IDIOMA]['mensagens'][{'jogador': 'vitoria', 'computador': 'derrota', 'empate': 'empate'}[vencedor]])
