import os # Importa o módulo os para achar o caminho do arquivo
...
# Programa principal
def main():
    # Obtem o caminho absoluto do diretório onde está o script atual
    diretorio_script = os.path.dirname(os.path.abspath(__file__))
    # Cria o caminho completo para o arquivo vendas.txt no mesmo diretório
    nome_arquivo = os.path.join(diretorio_script, "vendas.txt")
